          ...
          <MDBContainer>
            ...
            <MDBCollapse navbar show={toggle}>
              <ul className={'navbar-nav ms-auto mb-2 mb-lg-0'}>
                <MDBNavbarItem>
                  <NavLink to='/fitness' className={'nav-link d-flex flex-column text-center active'} aria-current="page">
                ...
                <MDBNavbarItem>
                  <MDBNavbarLink href='/blog' className={'nav-link d-flex flex-column text-center active'} aria-current="page">
