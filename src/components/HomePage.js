...
function HomePage() {
    ...
    return (
                            ...
                            <MDBCardBody>
                                ...
                                <div className="d-flex justify-content-around mt-3 pt-1">
                                    <p className="font-weight-bold mb-0">
                                        <a  className="link-post px-2 pt-3" data-mdb-ripple-color="dark"
                                           data-mdb-target="#exampleModal"  onClick={handleShow}> <i
      ...
      <div className="d-flex mb-3">
        <img src={'https://mdbootstrap.com/img/Photos/Avatars/img%20(9).jpg'} class="rounded-circle" height="55"/>
        <div className="ms-3">
            <h4>Francy 89</h4>
           
        </div>
        </div>
          <textarea placeholder="Describe yourself here..." rows={5} class="form-control">
               
                </textarea>
                <div className="d-flex my-4 border p-3">
                    <div>
                        <a href="#">Add to your post</a>
                    </div>
                    <div className="d-flex ms-auto">
                        <div className="px-3">
                           <a href="#"><i class="fa fa-image"></i> red</a>
                           <input type="file" style={{display: 'none'}}/>
                        </div>
                        <div className="px-3">
                        <a href="#"><i class="fa fa-map"></i> dr</a>
                        </div>
                        <div className="ps-3">
                            <a href="#">...</a>
                        </div>
                ...
                <Button variant="primary" className={'btn btn-index form-control'} ><span
            className="text-white"> Post</span></Button>
